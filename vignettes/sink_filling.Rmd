...
##devtools::load_all("c:/Users/d251l/OneDrive/Documents/Software/dynatopGIS")
##/home/paul/Documents/Software/dynamic_topmodel/dynatopGIS")
library(dynatopGIS)
library(raster)
```
...
```{r, data}
M <- rbind(NA,cbind(NA,matrix(1:100,10,10),NA),NA)
...
```{r, example1}
ex1 <- fake
ex1[c(29:32,41:44,54:55)] <- NA

ex1 <- create_catchment(ex1)
ex1[['channel_id']][1,1] <- 1
ex1 <- sink_fill(ex1)
plot(ex1[['dem']])
plot(ex1[['filled_dem']])
